...
- si usa Jira, asumir que el usuario luego deberá completar un `.env` compatible con los helpers del addon Ticketing (`JIRA_BASE_URL`, `JIRA_EMAIL`, `JIRA_API_TOKEN`),
